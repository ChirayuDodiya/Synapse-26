...
export default function ExportRegistrationsPage() {
  ...
  const handleExport = () => {
    ...
    alert(
      `Exporting ${
        options.scope
      } registrations as ${options.format.toUpperCase()}...`
    );
  };
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setOptions({ ...options, filterByEvent: e.target.value })
              }
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500"
            >
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Includes payment amounts, methods, and transaction IDs
                  </p>
                </div>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) =>
                    setOptions({
                      ...options,
                      includeGatewayCharges: e.target.checked,
                    })
                  }
                  className="w-4 h-4 text-indigo-600 rounded focus:ring-indigo-500"
                />
                <div>
                  <span className="text-gray-700">
                    Gateway Charges & Net Revenue
                  </span>
                  <p className="text-xs text-gray-500">
                    Calculates fees and net amounts for paid registrations
                  </p>
                </div>
              </label>
            </div>
