          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">
                ₹{totalStats.grossRevenue.toFixed(2)}
              </p>
            </div>
            <div className="text-4xl">💵</div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">
                ₹{totalStats.netRevenue.toFixed(2)}
              </p>
            </div>
            <div className="text-4xl">💰</div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6 border-b">
            <h2 className="text-xl font-semibold">
              Gateway Charge Configuration
            </h2>
            <p className="text-sm text-gray-600 mt-1">
              Configure charge percentages and fixed fees for each payment
              method
            </p>
          </div>
          <div className="p-6">
            ...
            <div className="space-y-4">
              {stats.map((stat) => {
                const chargePercentage = (
                  (stat.charges / stat.grossRevenue) *
                  100
                ).toFixed(2);
                return (
                    ...
                    <div className="mt-3">
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${(
                              (stat.netRevenue / stat.grossRevenue) *
                              100
                            ).toFixed(0)}%`,
                          }}
                        ></div>
                      ...
                      <p className="text-xs text-gray-500 mt-1 text-right">
                        {((stat.netRevenue / stat.grossRevenue) * 100).toFixed(
                          1
                        )}
                        % net retention
                      </p>
