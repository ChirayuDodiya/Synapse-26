      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <section className="rounded-2xl border border-teal-100 bg-white/90 p-6 shadow-lg">
          ...
          <p className="mb-4 text-sm text-slate-600">
            Select allowed participation types and set their fixed registration
            fees.
          </p>
              ...
              {formData.participationCategories.group.enabled && (
                <div className="space-y-3 rounded-lg border border-slate-200 bg-slate-50 p-3">
                  ...
                  <p className="text-xs italic text-slate-500">
                    Dropdown will show{" "}
                    {formData.participationCategories.group.minParticipants} to{" "}
                    {formData.participationCategories.group.maxParticipants}{" "}
                    participants.{" "}
        ...
        <section className="rounded-2xl border border-teal-100 bg-white/90 p-6 shadow-lg">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              onClick={() =>
                setFormData({ ...formData, freeForDau: !formData.freeForDau })
              }
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
