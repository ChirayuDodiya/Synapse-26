...
export default function EventsPage() {
  ...
  const getEnabledCategories = (
    participationCategories: Event["participationCategories"],
    freeForDau: boolean
  ) => {
        ...
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600">
              Create a new event for your fest.
            </p>
          </div>
        </div>
        <form
              ...
              <form onSubmit={handleEditSave} className="space-y-4 p-6">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleEditChange("venue", e.target.value)
                      }
                      className="w-full rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm shadow-sm outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
                      placeholder="Auditorium A, Ground, etc."
                      required
                ...
                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                  ...
                  <p className="mb-3 text-xs text-slate-500">
                    Select allowed participation types and set their fixed
                    registration fees.
                  </p>
